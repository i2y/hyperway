...
import (
	...
	context "context"
	errors "errors"
	testpb "github.com/i2y/hyperway/compatibility-tests/testpb"
	http "net/http"
	strings "strings"
)
...
type TestServiceClient interface {
	Echo(context.Context, *connect.Request[testpb.EchoRequest]) (*connect.Response[testpb.EchoResponse], error)
}
...
func NewTestServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TestServiceClient {
	...
	testServiceMethods := testpb.File_test_proto.Services().ByName("TestService").Methods()
...
func (c *testServiceClient) Echo(ctx context.Context, req *connect.Request[testpb.EchoRequest]) (*connect.Response[testpb.EchoResponse], error) {
...
func (UnimplementedTestServiceHandler) Echo(context.Context, *connect.Request[testpb.EchoRequest]) (*connect.Response[testpb.EchoResponse], error) {
